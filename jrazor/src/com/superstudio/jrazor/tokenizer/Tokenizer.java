...
import com.superstudio.jrazor.StateMachine;
...
import com.superstudio.jrazor.text.LookaheadToken;
...
//		using (LookaheadToken lookahead = Source.BeginLookahead())
	...
	protected final StateResult<TSymbol> afterRazorCommentTransition() 
	{
	...
	protected final StateResult<TSymbol> razorCommentBody() 
	{
