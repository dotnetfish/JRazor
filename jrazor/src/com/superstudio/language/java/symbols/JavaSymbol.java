...
{
	// Helper constructor
	public JavaSymbol(int offset, int line, int column, String content, JavaSymbolType type) throws ArgumentNullException
	{
	...
	public JavaSymbol(SourceLocation start, String content, JavaSymbolType type, Iterable<RazorError> errors) throws ArgumentNullException
	{
